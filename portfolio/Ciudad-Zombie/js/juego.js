...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    //obstaculo-valla horizontal
    new Obstaculo('imagenes/valla_horizontal.png', 100, 110, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 100, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 30, 1),
    //obstaculo-valla vertical
    new Obstaculo('imagenes/valla_vertical.png', 340, 430, 30, 30, 1),
    //obstaculo-bache
    new Obstaculo('imagenes/bache.png', 400, 110, 30, 30, 1),
    //obstaculo-Auto Verde Arriba/Abajo
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 130, 15, 30, 1),
    //obstaculo-Auto Verde Derecha/Izquierda 
  ...
  enemigos: [
    //new ZombieCaminante(sprite, x,  ancho, alto, velocidad, rangoMov)
    new ZombieCaminante('imagenes/zombie1.png', 150, 410, 10, 10, 0.5, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}),
    new ZombieCaminante('imagenes/zombie1.png', 300, 390, 10, 10, 0.5, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}),
    new ZombieCaminante('imagenes/zombie1.png', 300, 110, 10, 10, 0.5, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}),
    new ZombieCaminante('imagenes/zombie1.png', 450, 130, 10, 10, 0.5, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}),
    new ZombieCaminante('imagenes/zombie1.png', 800, 250, 10, 10, 0.5, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 1, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}, 'h'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 1, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 1, {desdeX: 0, hastaX: 577, desdeY: 0, hastaY: 961}, 'v'),
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  //función que cambia la orientación de la photo según la dirección 
  Jugador.rotatePhoto(tecla);
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
   //llama la función para mover el jugador
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      Obstaculo.prototype.chocar(Jugador, obstaculo.potencia,obstaculo);
      puedeMoverse = false
    }
  }, this)
  return puedeMoverse
